/*!
 * Bootstrap v4.5.2 (//getbootstrap.com/)
 * Copyright 2011-2020 The Bootstrap Authors (//github.com/twbs/bootstrap/graphs/contributors)
...
!(function (t, e) {
        ...
        (i.show = function (i) {
          if ((void 0 === i && (i = !1), !(this._element.disabled || e(this._element).hasClass('disabled') || e(this._menu).hasClass('show')))) {
            ...
            if ((e(r).trigger(s), !s.isDefaultPrevented())) {
              if (!this._inNavbar && i) {
                if ('undefined' == typeof n) throw new TypeError("Bootstrap's dropdowns require Popper.js (//popper.js.org/)");
                var l = this._element;
          ...
          if (!this._element.disabled && !e(this._element).hasClass('disabled') && e(this._menu).hasClass('show')) {
            ...
            e(o).trigger(i),
              i.isDefaultPrevented() ||
                (this._popper && this._popper.destroy(), e(this._menu).toggleClass('show'), e(o).toggleClass('show').trigger(e.Event('hidden.bs.dropdown', n)));
          }
        }),
        (i.dispose = function () {
  ...
  var B = 'tooltip',
    ...
    X = (function () {
      function t(t, e) {
        if ('undefined' == typeof n) throw new TypeError("Bootstrap's tooltips require Popper.js (//popper.js.org/)");
        (this._isEnabled = !0),
          (this._timeout = 0),
          (this._hoverState = ''),
          (this._activeTrigger = {}),

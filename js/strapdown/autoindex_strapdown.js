document.addEventListener('DOMContentLoaded', function () {
  ...
  strapdown.setAttribute('src', conf.strapdown ? conf.strapdown : '//strapdownjs.com/v/0.2/strapdown.js');

  // Create an XMP element for Strapdown.js to process.
  (xmp = document.createElement('xmp')), xmp.setAttribute('theme', conf.theme);
